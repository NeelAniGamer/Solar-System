...
import { CSS2DRenderer, CSS2DObject } from './assets/js/CSS2DRenderer.js';
...
function createPlanet(data){
    ...
    if(data.type==='star'){
        ...
        // Flat procedural disc — tilted spiral/elliptical card
...
// ════════════════════════════════════════════════════════════════════════════
const planetData = {
"Sun":{type:'star',typeBadge:'G-TYPE MAIN SEQUENCE STAR',size:70,dist:0,period:0,color:0xffaa00,texture:'/assets/sun.jpg',moons:'0',
...
"Mercury":{type:'planet',typeBadge:'TERRESTRIAL PLANET',size:6,dist:140,period:88,color:0x888888,texture:'./assets/mercury.jpg',moons:'0',atmosphereColor:null,
...
"Venus":{type:'planet',typeBadge:'TERRESTRIAL PLANET',size:10,dist:190,period:225,color:0xffaa55,texture:'./assets/venus.jpg',moons:'0',atmosphereColor:0xff8833,
...
"Earth":{type:'planet',typeBadge:'TERRESTRIAL PLANET',size:12,dist:260,period:365.25,color:0x4b90ff,texture:'./assets/earth.jpg',moons:'0',atmosphereColor:0x4488ff,
...
"ISS":{type:'probe',typeBadge:'SPACE STATION',size:0.4,dist:261.5,period:0.06,color:0xffffff,texture:'',moons:'0',parent:'Earth',
...
"Hubble":{type:'probe',typeBadge:'SPACE TELESCOPE',size:0.3,dist:263,period:0.07,color:0xcccccc,texture:'',moons:'0',parent:'Earth',
...
"JWST":{type:'probe',typeBadge:'INFRARED TELESCOPE',size:0.6,dist:275,period:365.25,color:0xffcc00,texture:'',moons:'0',
...
"Mars":{type:'planet',typeBadge:'TERRESTRIAL PLANET',size:8,dist:330,period:687,color:0xff5533,texture:'./assets/mars.jpg',moons:'2',atmosphereColor:0xff4422,
...
"Ceres":{type:'dwarf',typeBadge:'DWARF PLANET',size:3,dist:420,period:1682,color:0xaaaaaa,texture:'./assets/moon.jpg',moons:'0',
...
"Jupiter":{type:'planet',typeBadge:'GAS GIANT',size:45,dist:580,period:4333,color:0xddaa77,texture:'./assets/jupiter.jpg',moons:'95',atmosphereColor:0xddaa44,
...
"Europa":{type:'planet',typeBadge:'MOON OF JUPITER',size:7,dist:592,period:3.55,color:0xd0e8f0,texture:'',moons:'0',parent:'Jupiter',subtype:'europa',
...
"Io":{type:'planet',typeBadge:'MOON OF JUPITER',size:5,dist:597,period:1.77,color:0xffcc44,texture:'',moons:'0',parent:'Jupiter',subtype:'io',
...
"Ganymede":{type:'planet',typeBadge:'MOON OF JUPITER',size:9,dist:606,period:7.15,color:0xaabbcc,texture:'',moons:'0',parent:'Jupiter',
...
"Saturn":{type:'planet',typeBadge:'GAS GIANT',size:38,dist:780,period:10759,color:0xe3d599,texture:'./assets/saturn.jpg',moons:'146',atmosphereColor:0xddcc77,
...
"Titan":{type:'planet',typeBadge:'MOON OF SATURN',size:8,dist:793,period:15.9,color:0xdd8833,texture:'',moons:'0',parent:'Saturn',subtype:'titan',
...
"Enceladus":{type:'planet',typeBadge:'MOON OF SATURN',size:3.5,dist:785,period:1.37,color:0xeef8ff,texture:'',moons:'0',parent:'Saturn',subtype:'enceladus',
...
"Uranus":{type:'planet',typeBadge:'ICE GIANT',size:28,dist:960,period:30687,color:0x66ccff,texture:'./assets/uranus.jpg',moons:'28',atmosphereColor:0x55bbff,
...
"Neptune":{type:'planet',typeBadge:'ICE GIANT',size:26,dist:1120,period:60190,color:0x3366ff,texture:'./assets/neptune.jpg',moons:'16',atmosphereColor:0x2255ff,
...
"Triton":{type:'planet',typeBadge:'MOON OF NEPTUNE',size:5,dist:1128,period:5.88,color:0xddccbb,texture:'',moons:'0',parent:'Neptune',
...
"Pluto":{type:'dwarf',typeBadge:'DWARF PLANET / KBO',size:4,dist:1300,period:90560,color:0xaaaaaa,texture:'./assets/pluto.jpg',moons:'5',
...
"Haumea":{type:'dwarf',typeBadge:'DWARF PLANET',size:3.5,dist:1360,period:103774,color:0xcccccc,texture:'./assets/moon.jpg',moons:'2',
...
"Makemake":{type:'dwarf',typeBadge:'DWARF PLANET',size:3.8,dist:1420,period:112897,color:0xbb9988,texture:'./assets/moon.jpg',moons:'1',
...
"Eris":{type:'dwarf',typeBadge:'DWARF PLANET',size:4.2,dist:1550,period:203830,color:0xdddddd,texture:'./assets/moon.jpg',moons:'1',
...
"Halley's Comet":{type:'comet',typeBadge:'SHORT-PERIOD COMET',size:2,dist:450,period:27484,color:0x88bbff,texture:'./assets/moon.jpg',moons:'0',
...
"'Oumuamua":{type:'interstellar',typeBadge:'INTERSTELLAR OBJECT',size:1.5,dist:650,period:0,color:0x885544,texture:'',moons:'0',
...
"Voyager 1":{type:'probe',typeBadge:'INTERSTELLAR PROBE',size:1.2,dist:1900,period:0,color:0xffffff,texture:'',moons:'0',
...
"New Horizons":{type:'probe',typeBadge:'KBO EXPLORER',size:0.8,dist:1700,period:0,color:0xddddff,texture:'',moons:'0',
...
"OSIRIS-REx":{type:'probe',typeBadge:'ASTEROID SAMPLER',size:0.6,dist:310,period:1.3,color:0xddcc88,texture:'',moons:'0',
...
"InSight":{type:'probe',typeBadge:'MARS LANDER',size:0.7,dist:328,period:0,color:0xcc8855,texture:'',moons:'0',
...
"Sagittarius A*":{type:'blackhole',typeBadge:'SUPERMASSIVE BLACK HOLE',size:22,dist:8800,period:0,color:0x000000,texture:'',moons:'0',
...
"Crab Pulsar":{type:'pulsar',typeBadge:'NEUTRON STAR PULSAR',size:6,dist:4000,period:0,color:0x88ccff,texture:'',moons:'0',
...
"Proxima Centauri":{type:'star',typeBadge:'RED DWARF STAR',size:9,dist:3400,period:0,color:0xff4422,texture:'',moons:'0',
...
"Andromeda Galaxy":{type:'galaxy',typeBadge:'SPIRAL GALAXY',size:38,dist:2500,period:0,color:0xddccbb,texture:'',moons:'0',
...
"Milky Way Core":{type:'star',typeBadge:'GALACTIC CORE BULGE',size:30,dist:8600,period:0,color:0xffcc55,texture:'',moons:'0',
...
// ── MOONS OF EARTH ────────────────────────────────────────────────────────────
"Luna":{type:'planet',typeBadge:'EARTH\'S MOON',size:5,dist:210,period:27.3,color:0xaaaaaa,texture:'./assets/moon.jpg',moons:'0',parent:'Earth',subtype:'luna',
...
// ── MOONS OF MARS ─────────────────────────────────────────────────────────────
"Phobos":{type:'planet',typeBadge:'MOON OF MARS',size:1.5,dist:332,period:0.32,color:0x998877,texture:'',moons:'0',parent:'Mars',subtype:'phobos',
...
"Deimos":{type:'planet',typeBadge:'MOON OF MARS',size:1.0,dist:334,period:1.26,color:0x887766,texture:'',moons:'0',parent:'Mars',subtype:'deimos',
...
"Callisto":{type:'planet',typeBadge:'MOON OF JUPITER',size:8.5,dist:612,period:16.69,color:0x887766,texture:'',moons:'0',parent:'Jupiter',subtype:'callisto',
...
"Mimas":{type:'planet',typeBadge:'MOON OF SATURN',size:2.5,dist:787,period:0.94,color:0xccbbaa,texture:'',moons:'0',parent:'Saturn',subtype:'mimas',
...
"Dione":{type:'planet',typeBadge:'MOON OF SATURN',size:3.0,dist:788,period:2.74,color:0xddddd0,texture:'',moons:'0',parent:'Saturn',subtype:'dione',
...
"Rhea":{type:'planet',typeBadge:'MOON OF SATURN',size:3.5,dist:789,period:4.52,color:0xddcccc,texture:'',moons:'0',parent:'Saturn',subtype:'rhea',
...
"Iapetus":{type:'planet',typeBadge:'MOON OF SATURN',size:3.5,dist:791,period:79.3,color:0x997744,texture:'',moons:'0',parent:'Saturn',subtype:'iapetus',
...
// ── MOON OF URANUS ────────────────────────────────────────────────────────────
"Miranda":{type:'planet',typeBadge:'MOON OF URANUS',size:2.0,dist:961,period:1.41,color:0xaabbcc,texture:'',moons:'0',parent:'Uranus',subtype:'miranda',
...
// ── MOON OF PLUTO ─────────────────────────────────────────────────────────────
"Charon":{type:'planet',typeBadge:'MOON OF PLUTO',size:3.2,dist:1302,period:6.39,color:0xaaaaaa,texture:'./assets/moon.jpg',moons:'0',parent:'Pluto',subtype:'charon',
...
// ── NEW STARS ─────────────────────────────────────────────────────────────────
"Betelgeuse":{type:'star',typeBadge:'RED SUPERGIANT',size:18,dist:4500,period:0,color:0xff4400,texture:'',moons:'0',
...
"Sirius":{type:'star',typeBadge:'BINARY STAR SYSTEM',size:11,dist:3600,period:0,color:0xaaddff,texture:'',moons:'0',
...
// ── NEBULAE ───────────────────────────────────────────────────────────────────
"Orion Nebula":{type:'star',typeBadge:'EMISSION NEBULA',size:20,dist:5500,period:0,color:0xff6622,texture:'',moons:'0',subtype:'nebula',
...
"Pillars of Creation":{type:'star',typeBadge:'STELLAR NURSERY',size:16,dist:6000,period:0,color:0xaa6644,texture:'',moons:'0',subtype:'nebula',
...
"Helix Nebula":{type:'star',typeBadge:'PLANETARY NEBULA',size:14,dist:6800,period:0,color:0x3366ff,texture:'',moons:'0',subtype:'nebula',
...
"Laniakea":{type:'galaxy',typeBadge:'SUPERCLUSTER',size:35,dist:7500,period:0,color:0xffddaa,texture:'',moons:'0',
...
"Dark Matter":{type:'blackhole',typeBadge:'INVISIBLE MASS',size:15,dist:9200,period:0,color:0x221133,texture:'',moons:'0',
...
"Dark Energy":{type:'blackhole',typeBadge:'COSMIC FORCE',size:12,dist:9500,period:0,color:0x110022,texture:'',moons:'0',
...
"Cosmic Microwave Background":{type:'galaxy',typeBadge:'RELIC RADIATION',size:25,dist:9800,period:0,color:0xffddbb,texture:'',moons:'0',
...
"Sedna":{type:'dwarf',typeBadge:'EXTREME DWARF PLANET',size:3,dist:1750,period:4404000,color:0xff4422,texture:'./assets/moon.jpg',moons:'0',
...
"Arrokoth":{type:'dwarf',typeBadge:'KUIPER BELT OBJECT',size:1.0,dist:1720,period:297620,color:0xcc9966,texture:'',moons:'0',
